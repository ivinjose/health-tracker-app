 ...
 *
 * @param {string} name - Key in `PALETTES` (`light` or `iosDark`).
 * @returns {Object} Colors, CSS vars, calendar, navigation, chart, and layout tokens.
 */
 ...
 *
 * `'dark'` is treated as `'iosDark'`. Unknown names (and a missing argument)
 * fall back to {@link APP_APPEARANCE}.
 *
 * @param {string} [name='iosDark'] - Requested appearance name.
 ...
 *
 * @param {string} [name='iosDark'] - Requested appearance name.
 * @returns {Object} The assembled appearance for that palette.
 */
